...
class _CropAIScreenState extends State<CropAIScreen> {
  ...
  bool _isCropSpecificQuery(String message) {
    final cropKeywords = [
      ...
      'rice', 'wheat', 'corn', 'maize', 'tomato', 'potato', 'cotton',
      'sugarcane', 'soybean', 'vegetables', 'fruits'
    ];
  ...
  String _extractCropType(String message) {
    const crops = [
      'rice', 'wheat', 'corn', 'maize', 'tomato', 'potato', 'cotton',
      'sugarcane', 'soybean', 'sunflower', 'mustard', 'barley',
      'onion', 'garlic', 'carrot', 'cabbage', 'cauliflower',
      'brinjal', 'okra', 'chilli', 'pepper', 'cucumber'
    ];
